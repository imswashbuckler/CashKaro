...
public class StringLiterlasandStringObjects {
	public static void main(String[] args) {
		...
		s11.replace("Java", "Kava");// replaces all occurrences of "Java" to
									// "Kava"
		...
		if (str2 == sb.toString()) {
			...
			System.out.println("str2 and sb not in same location");
		}

		if (str2.equals(sb.toString())) {
			System.out.println("sb and str2 same data");
		} else {
			System.out.println("sb and str2 not same data");
		}

		if (str2 == sb2.toString()) {
			System.out.println("str2 and sb2 same location");
		} else {
			System.out.println("str2 and sb2 not in same location");
		}

		if (str2.equals(sb2.toString())) {
			System.out.println("sb2 and str2 same data");
		} else {
			System.out.println("sb2 and str2 not same data");
		}

		if (sb1 == sb) {
			System.out.println("sb and sb1 same location");
		} else {
			System.out.println("sb and sb1 not same location");
		}

		if (sb1.equals(sb)) {
			System.out.println("sb and sb1 same data");
		} else {
			System.out.println("sb and sb1 not same data");
		}
